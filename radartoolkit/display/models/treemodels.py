...
from ..bindings import (Qt, QtCore, QtSignal, QtSlot)
from ..utils.check_class import check_is_a_string
from ..settings import TREE_CELL_SIZE_HINT, DEBUGGING
...
class BaseTreeModel(QtCore.QAbstractItemModel):
    ...
    # will see this is radartoolkit specific and thus find this definition more easily.
    ...
    def setData(self, index, value, role=Qt.EditRole):
        ...
        if role != Qt.ItemDataRole.CheckStateRole and role != Qt.EditRole:
            return False
        ...
        try:
            ...
            if result:
                ...
                self.model.emitDataChanged(treeItem)
