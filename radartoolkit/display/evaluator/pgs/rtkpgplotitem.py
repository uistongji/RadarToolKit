...
""" Module that contains RTKPgPlotItem.
"""

from ...bindings import Qt, QtWidgets, QtCore, QtSignal, QtGui
...
class RTKPgPlotItem(PlotItem):
    ...
    # zjy the reason why Autorange is closed remain to be discussed with chenlv...
    ...
    def __init__(self,
        ...
        """
        super(RTKPgPlotItem, self).__init__(*args, **kwargs)
    ...
    def close(self):
        ...
        super(RTKPgPlotItem, self).close()
    ...
    def emitResetAxisSignal(self, axisNumber):
        ...
        logger.debug("ISRPgPlotItem.autoBtnClicked, mode:{}".format(self.autoBtn.mode))
