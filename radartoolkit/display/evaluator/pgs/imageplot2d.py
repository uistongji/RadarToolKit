...
from ...bindings import QtCore, QtGui, QtSlot
from ...config.ctis.pgctis import (X_AXIS, Y_AXIS, NO_LABEL_STR, defaultAutoRangeMethods, PgAxisLabelCti,
...
class PgImagePlot2dCti(MainGroupCti):
    ...
    def __init__(self, pgImagePlot2d, nodeName):
        ...
        self.yAxisCti.insertChild(
            PgAxisLabelCti(imagePlotItem, 'right', self.pgImagePlot2d.collector,
                           defaultData=0,
...
class PgImagePlot2d(AbstractInspector):
    ...
    def __init__(self, collector, parent=None):
        ...
        # pgcolorbar.colorlegend ->self.colorScaleViewBox.setMaximumWidth(15)
        ...
        # 20230927 zjy change the width of AScan
        ...
        # 20230927 zjy hide the axis when init but will show when data load need to be checked
        ...
        self.graphicsLayoutWidget.addItem(self.imagePlotItem, ROW_IMAGE, COL_IMAGE)  # BScan & AScan zjy
    ...
    def _drawContents(self, reason=None, initiator=None):
        ...
        # the QGraphicsGridLayout instance
        ...
        if self.config.crossPlotGroupCti.checkState != QtCore.Qt.Unchecked:
        ...
        # allows the RTKColorLegendItem to make histogram bins as if it were an integer
